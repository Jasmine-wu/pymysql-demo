...
class User(db.Model):
    ...
    addtime = db.Column(db.DateTime, index=True)  # 注册时间
...
class Userlog(db.Model):
    ...
    addtime = db.Column(db.DateTime, index=True)  # 登录时间
...
class Tag(db.Model):
    ...
    addtime = db.Column(db.DateTime, index=True)  # 添加时间
...
#     admin = Admin(
#         name="liuqingzheng",
#         pwd=generate_password_hash("liuqingzheng123"),
#         is_super=0,
#         role_id=1
#     )
